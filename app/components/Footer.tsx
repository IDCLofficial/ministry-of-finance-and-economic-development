                                ...
                                <AnimatedEntrance {...ANIMATION_PRESETS.TEXT_FADE_LEFT} delay={200}>
                                    <div className="text-center md:text-left">
                                        ...
                                        <p className="max-w-lg opacity-70 text-sm sm:text-base leading-relaxed">
                                            Have questions about our financial services, projects, or need assistance? Contact us for prompt and professional support.
                                        </p>
                                    </div>
                                </AnimatedEntrance>
                            ...
                            <div className="sm:col-span-2 md:col-span-1">
                                <Link href="/" className="group cursor-pointer">
                                    <div className="flex flex-col sm:flex-row items-start sm:items-center mb-4 sm:mb-6">
                                        ...
                                        <span className="text-base sm:text-lg md:text-xl font-bold flex-1 leading-tight transition-colors duration-300 group-hover:text-green-300">Ministry of Finance and Economic Development</span>
                                    </div>
                                </Link>
                                <p className="text-gray-300 leading-relaxed text-sm sm:text-base hover:text-gray-200 transition-colors duration-300">
                                    The Ministry of Finance and Economic Development manages financial resources with transparency, integrity, and efficiency to promote sustainable development and improve service delivery in Imo State.
                                </p>
                            </div>
                        </AnimatedEntrance>
                        ...
                        <AnimatedEntrance {...ANIMATION_PRESETS.CARD_FADE_UP} delay={STAGGER_DELAYS.MEDIUM[3]}>
                            <div>
                                ...
                                <div className="mt-4 sm:mt-6 space-y-1 sm:space-y-2 text-xs sm:text-sm text-gray-300 grid">
                                    <a href="tel:083-230940" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">083-230940</a>
                                    <a href="mailto:info@finance.imostate.gov.ng" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">info@finance.imostate.gov.ng</a>
                                    ...
                                    <div className="flex space-x-4 mt-2">
                                        <a href="https://facebook.com/imofinance" target="_blank" rel="noopener noreferrer" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">
                                            Facebook
                                        </a>
                                        <a href="https://twitter.com/imofinance" target="_blank" rel="noopener noreferrer" className="hover:text-green-300 transition-colors duration-300 cursor-pointer">
                                            Twitter
                                        </a>
